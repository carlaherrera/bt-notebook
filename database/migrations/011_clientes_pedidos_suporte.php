...
if ($driver === 'mysql') {
    $stmts = [
        ...
        "DROP TABLE IF EXISTS {$prefix}consignado_produtos",
        "DROP TABLE IF EXISTS {$prefix}consignado_movimentacoes",
        "DROP TABLE IF EXISTS {$prefix}ticket_mensagens",
        "DROP TABLE IF EXISTS {$prefix}tickets",
        "DROP TABLE IF EXISTS {$prefix}notas_fiscais",
        "DROP TABLE IF EXISTS {$prefix}faturas",
        "DROP TABLE IF EXISTS {$prefix}pedido_eventos",
        "DROP TABLE IF EXISTS {$prefix}pedido_itens",
        "DROP TABLE IF EXISTS {$prefix}pedidos",
        "DROP TABLE IF EXISTS {$prefix}metodos_pagamento",
        "DROP TABLE IF EXISTS {$prefix}enderecos",
        <<<SQL
        ...
        CREATE TABLE IF NOT EXISTS {$prefix}pedidos (
          ...
          pagamento_id INT UNSIGNED DEFAULT NULL,
        ...
        CREATE TABLE IF NOT EXISTS {$prefix}faturas (
          id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
          pedido_id INT UNSIGNED NOT NULL,
          metodo_id INT UNSIGNED DEFAULT NULL,
