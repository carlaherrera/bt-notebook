...
$title = 'Entrar - FerramentasAi';
$description = 'Acesse sua conta na plataforma FerramentasAi';
                ...
                <div class="flex items-center text-sm text-gray-700 dark:text-gray-300">
                    <label class="inline-flex items-center gap-2 select-none">
                        <input 
                            type="checkbox" 
                            name="remember" 
                            class="rounded border-gray-300 dark:border-gray-600 text-[var(--primary-color)] focus:ring-[var(--primary-color)] focus:ring-offset-0"
                        >
                        <span class="whitespace-nowrap">Manter-me conectado</span>
                    </label>
                </div>
