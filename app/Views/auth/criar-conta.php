...
$title = 'Criar Conta - FerramentasAi';
$description = 'Crie sua conta na plataforma FerramentasAi';
    ...
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8 sm:mb-10">
            ...
            <p class="text-gray-600 dark:text-gray-400 text-sm sm:text-base">
                Junte-se à plataforma FerramentasAi
            </p>
        </div>
        ...
        <div class="rounded-3xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-sm p-6 sm:p-8 space-y-6">
            ...
            <form action="/criar-conta" method="POST" class="space-y-5">
            ...
            <div class="flex items-center justify-center text-sm">
                <span class="text-gray-600 dark:text-gray-400">Já tem conta? </span>
                <a 
                    href="/entrar" 
                    class="ml-1 text-[color-mix(in_srgb,var(--primary-color)_85%,black_15%)] dark:text-[color-mix(in_srgb,var(--primary-color)_80%,white_20%)] hover:text-[var(--primary-color)] dark:hover:text-[color-mix(in_srgb,var(--primary-color)_90%,white_10%)] transition font-medium"
                >
                    Faça login
                </a>
            </div>
