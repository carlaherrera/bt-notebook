...
$router->get('/admin/parceiros/novo', ['Admin\\ParceirosController', 'create'], ['auth', 'role:admin', \App\Middlewares\TermsMiddleware::class]);
$router->post('/admin/parceiros', ['Admin\\ParceirosController', 'store'], ['auth', 'role:admin', \App\Middlewares\TermsMiddleware::class]);
$router->get('/admin/parceiros/{id}/editar', ['Admin\\ParceirosController', 'edit'], ['auth', 'role:admin', \App\Middlewares\TermsMiddleware::class]);
$router->post('/admin/parceiros/{id}/editar', ['Admin\\ParceirosController', 'update'], ['auth', 'role:admin', \App\Middlewares\TermsMiddleware::class]);
$router->post('/admin/parceiros/{id}/toggle', ['Admin\\ParceirosController', 'toggle'], ['auth', 'role:admin', \App\Middlewares\TermsMiddleware::class]);
...
$router->get('/admin/produtos/novo', ['Admin\\ProdutosController', 'create'], ['auth', 'role:admin', \App\Middlewares\TermsMiddleware::class]);
$router->post('/admin/produtos', ['Admin\\ProdutosController', 'store'], ['auth', 'role:admin', \App\Middlewares\TermsMiddleware::class]);
$router->get('/admin/produtos/{id}/editar', ['Admin\\ProdutosController', 'edit'], ['auth', 'role:admin', \App\Middlewares\TermsMiddleware::class]);
$router->post('/admin/produtos/{id}/editar', ['Admin\\ProdutosController', 'update'], ['auth', 'role:admin', \App\Middlewares\TermsMiddleware::class]);
$router->post('/admin/produtos/{id}/toggle', ['Admin\\ProdutosController', 'toggle'], ['auth', 'role:admin', \App\Middlewares\TermsMiddleware::class]);
$router->post('/admin/produtos/{id}/excluir', ['Admin\\ProdutosController', 'destroy'], ['auth', 'role:admin', \App\Middlewares\TermsMiddleware::class]);
...
$router->post('/admin/movimentacoes', ['Admin\\MovimentacoesController', 'store'], ['auth', 'role:admin', \App\Middlewares\TermsMiddleware::class]);
$router->get('/admin/movimentacoes/{id}/editar', ['Admin\\MovimentacoesController', 'edit'], ['auth', 'role:admin', \App\Middlewares\TermsMiddleware::class]);
$router->post('/admin/movimentacoes/{id}/editar', ['Admin\\MovimentacoesController', 'update'], ['auth', 'role:admin', \App\Middlewares\TermsMiddleware::class]);
$router->post('/admin/movimentacoes/{id}/excluir', ['Admin\\MovimentacoesController', 'destroy'], ['auth', 'role:admin', \App\Middlewares\TermsMiddleware::class]);
...
$router->get('/admin/auditoria/nova', ['Admin\\AuditoriaController', 'create'], ['auth', 'role:admin', \App\Middlewares\TermsMiddleware::class]);
$router->post('/admin/auditoria', ['Admin\\AuditoriaController', 'store'], ['auth', 'role:admin', \App\Middlewares\TermsMiddleware::class]);
$router->get('/admin/auditoria/{id}/editar', ['Admin\\AuditoriaController', 'edit'], ['auth', 'role:admin', \App\Middlewares\TermsMiddleware::class]);
$router->post('/admin/auditoria/{id}/editar', ['Admin\\AuditoriaController', 'update'], ['auth', 'role:admin', \App\Middlewares\TermsMiddleware::class]);
$router->post('/admin/auditoria/{id}/excluir', ['Admin\\AuditoriaController', 'destroy'], ['auth', 'role:admin', \App\Middlewares\TermsMiddleware::class]);
...
$router->post('/admin/consignado/transferir', ['Admin\\ConsignadoController', 'transferir'], ['auth', 'role:admin', \App\Middlewares\TermsMiddleware::class]);
$router->post('/admin/consignado/devolver', ['Admin\\ConsignadoController', 'devolver'], ['auth', 'role:admin', \App\Middlewares\TermsMiddleware::class]);
